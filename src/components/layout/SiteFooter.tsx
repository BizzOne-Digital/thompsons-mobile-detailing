      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 lg:grid-cols-4 lg:px-8">
        <div>
          <div className="flex items-center gap-3">
            ...
            />
            <p className="font-display text-lg text-bright-gold">{site.businessName}</p>
          </div>
          <p className="mt-4 text-sm text-off-white/75">
            {site.footerText ||
              `${site.tagline}. Professional mobile auto detailing across the Phoenix Metro.`}
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-off-white/80">
            ...
            <li>
              <a href={phoneHref(site.phone)} className="hover:text-bright-gold">
                {site.phone}
              </a>
            </li>
            <li>
              <a href={`mailto:${site.email}`} className="hover:text-bright-gold">
                {site.email}
              </a>
            </li>
          </ul>
